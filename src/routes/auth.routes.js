...
router.get("/password-reset-status/:requestId", authController.getPasswordResetStatus);
router.get("/password-reset/approve", authController.approvePasswordReset);
router.get("/password-reset/deny", authController.denyPasswordReset);
